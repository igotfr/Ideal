## Reason
A `class` or `struct` don't need an automatic class constructor and explicit fields, it's confusing and unnecessary

## Proposal
use the automatic class constructor like syntax to declare or to implement an aggregate and constructor syntax to instanciate:
```rust
